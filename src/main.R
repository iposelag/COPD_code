## The data split should be named as expression_train, expression_test
# INPUTS
# target_var <- "dis_condition"
# # genes_list <- "disease_related"
# directory_to_save <- "../COPD/proba/"
# models_to_run <- "rf,glm"
# ml_models_to_run_vector <- strsplit(models_to_run, ",")[[1]]
# file_name <- "expression"

# procedure <- "disease_related"
# directory_to_load <- "../COPD/raw_data/"
# disease_code <- "C0024117"

# threshold_values <- 0.031
# dea_genes <- NULL # if null load from folder otherwise provide a vector of characters with  the list of genes

#DEA genes .txt file with genes in a unique column
